...
const sayHelloButtonBGChange = ()=>{
    sayHelloButton.style.backgroundColor = "black";
    sayHelloButton.style.color = "white"
}

sayHelloButton.addEventListener("mouseover",sayHelloButtonBGChange)
...
*/
const sayHelloButtonBGNormal = ()=>{
    sayHelloButton.style.backgroundColor = "#EFEFEF";
    sayHelloButton.style.color = "black"
}

sayHelloButton.addEventListener("mouseout",sayHelloButtonBGNormal);
// PROBLEM 4
/*
...
const repeatMyParam = () => {
    ...
    axios.get(`http://localhost:3000/repeat/helloParam`)
        .then((res)=>{
...
const queryTest = (event) =>{
    ...
    axios.get(`http://localhost:3000/query-test/?age=red&blue=5`)
        .then((res)=>{
...
let foodInput = document.getElementById("foodBox");
...
theForm.addEventListener("submit",createFood)